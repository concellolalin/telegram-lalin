...
CREATE TABLE `botan_shortener` (
  ...
  `url` text COLLATE utf8_general_ci NOT NULL COMMENT 'Original URL',
  `short_url` char(255) COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'Shortened URL',
...
CREATE TABLE `callback_query` (
  ...
  `inline_message_id` char(255) COLLATE utf8_general_ci DEFAULT NULL COMMENT 'Identifier of the message sent via the bot in inline mode, that originated the query',
  `data` char(255) COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'Data associated with the callback button',
  `created_at` timestamp NULL DEFAULT NULL COMMENT 'Entry date creation',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `chat_id` (`chat_id`),
...
CREATE TABLE `chat` (
  ...
  `type` enum('private','group','supergroup','channel') COLLATE utf8_general_ci NOT NULL COMMENT 'Chat type, either private, group, supergroup or channel',
  `title` char(255) COLLATE utf8_general_ci DEFAULT '' COMMENT 'Chat (group) title, is null if chat type is private',
  `username` char(255) COLLATE utf8_general_ci DEFAULT NULL COMMENT 'Username, for private chats, supergroups and channels if available',
...
CREATE TABLE `chosen_inline_result` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
  `result_id` char(255) COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'Identifier for this result',
  `user_id` bigint(20) DEFAULT NULL COMMENT 'Unique user identifier',
  `location` char(255) COLLATE utf8_general_ci DEFAULT NULL COMMENT 'Location object, user''s location',
  `inline_message_id` char(255) COLLATE utf8_general_ci DEFAULT NULL COMMENT 'Identifier of the sent inline message',
  `query` text COLLATE utf8_general_ci NOT NULL COMMENT 'The query that was used to obtain the result',
  `created_at` timestamp NULL DEFAULT NULL COMMENT 'Entry date creation',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
...
CREATE TABLE `conversation` (
  ...
  `status` enum('active','cancelled','stopped') COLLATE utf8_general_ci NOT NULL DEFAULT 'active' COMMENT 'Conversation state',
  `command` varchar(160) COLLATE utf8_general_ci DEFAULT '' COMMENT 'Default command to execute',
  `notes` text COLLATE utf8_general_ci COMMENT 'Data stored from command',
  `created_at` timestamp NULL DEFAULT NULL COMMENT 'Entry date creation',
  `updated_at` timestamp NULL DEFAULT NULL COMMENT 'Entry date update',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
...
CREATE TABLE `edited_message` (
  ...
  `text` text COLLATE utf8_general_ci COMMENT 'For text messages, the actual UTF-8 text of the message max message length 4096 char utf8',
  `entities` text COLLATE utf8_general_ci COMMENT 'For text messages, special entities like usernames, URLs, bot commands, etc. that appear in the text',
  `caption` text COLLATE utf8_general_ci COMMENT 'For message with caption, the actual UTF-8 text of the caption',
  PRIMARY KEY (`id`),
  KEY `chat_id` (`chat_id`),
  KEY `message_id` (`message_id`),
  KEY `user_id` (`user_id`),
...
CREATE TABLE `inline_query` (
  `id` bigint(20) unsigned NOT NULL COMMENT 'Unique identifier for this query',
  `user_id` bigint(20) DEFAULT NULL COMMENT 'Unique user identifier',
  `location` char(255) COLLATE utf8_general_ci DEFAULT NULL COMMENT 'Location of the user',
  `query` text COLLATE utf8_general_ci NOT NULL COMMENT 'Text of the query',
  `offset` char(255) COLLATE utf8_general_ci DEFAULT NULL COMMENT 'Offset of the result',
  `created_at` timestamp NULL DEFAULT NULL COMMENT 'Entry date creation',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
...
CREATE TABLE `message` (
  ...
  `media_group_id` text COLLATE utf8_general_ci COMMENT 'The unique identifier of a media message group this message belongs to',
  `text` text COLLATE utf8_general_ci COMMENT 'For text messages, the actual UTF-8 text of the message max message length 4096 char utf8',
  `entities` text COLLATE utf8_general_ci COMMENT 'For text messages, special entities like usernames, URLs, bot commands, etc. that appear in the text',
  `audio` text COLLATE utf8_general_ci COMMENT 'Audio object. Message is an audio file, information about the file',
  `document` text COLLATE utf8_general_ci COMMENT 'Document object. Message is a general file, information about the file',
  `photo` text COLLATE utf8_general_ci COMMENT 'Array of PhotoSize objects. Message is a photo, available sizes of the photo',
  `sticker` text COLLATE utf8_general_ci COMMENT 'Sticker object. Message is a sticker, information about the sticker',
  `video` text COLLATE utf8_general_ci COMMENT 'Video object. Message is a video, information about the video',
  `voice` text COLLATE utf8_general_ci COMMENT 'Voice Object. Message is a Voice, information about the Voice',
  `video_note` text COLLATE utf8_general_ci COMMENT 'VoiceNote Object. Message is a Video Note, information about the Video Note',
  `contact` text COLLATE utf8_general_ci COMMENT 'Contact object. Message is a shared contact, information about the contact',
  `location` text COLLATE utf8_general_ci COMMENT 'Location object. Message is a shared location, information about the location',
  `venue` text COLLATE utf8_general_ci COMMENT 'Venue object. Message is a Venue, information about the Venue',
  `caption` text COLLATE utf8_general_ci COMMENT 'For message with caption, the actual UTF-8 text of the caption',
  `new_chat_members` text COLLATE utf8_general_ci COMMENT 'List of unique user identifiers, new member(s) were added to the group, information about them (one of these members may be the bot itself)',
  ...
  `new_chat_title` char(255) COLLATE utf8_general_ci DEFAULT NULL COMMENT 'A chat title was changed to this value',
  `new_chat_photo` text COLLATE utf8_general_ci COMMENT 'Array of PhotoSize objects. A chat photo was change to this value',
  ...
  `pinned_message` text COLLATE utf8_general_ci COMMENT 'Message object. Specified message was pinned',
...
CREATE TABLE `request_limiter` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
  `chat_id` char(255) COLLATE utf8_general_ci DEFAULT NULL COMMENT 'Unique chat identifier',
  `inline_message_id` char(255) COLLATE utf8_general_ci DEFAULT NULL COMMENT 'Identifier of the sent inline message',
  `method` char(255) COLLATE utf8_general_ci DEFAULT NULL COMMENT 'Request method',
  `created_at` timestamp NULL DEFAULT NULL COMMENT 'Entry date creation',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user` (
  ...
  `first_name` char(255) COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'User''s first name',
  `last_name` char(255) COLLATE utf8_general_ci DEFAULT NULL COMMENT 'User''s last name',
  `username` char(191) COLLATE utf8_general_ci DEFAULT NULL COMMENT 'User''s username',
  `language_code` char(10) COLLATE utf8_general_ci DEFAULT NULL COMMENT 'User''s system language',
  `created_at` timestamp NULL DEFAULT NULL COMMENT 'Entry date creation',
  `updated_at` timestamp NULL DEFAULT NULL COMMENT 'Entry date update',
  PRIMARY KEY (`id`),
